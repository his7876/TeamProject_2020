...
def main():
    ...
    xml = 'C:\\Users\\judy8\\Downloads\\haarcascade_frontalface_default.xml'
    ...
    x = []
    img = Image.open('C:\\Users\\judy8\\OneDrive\\바탕 화면\\web_cam_cropped.jpg')
    img = img.convert("RGB")
    data = np.asarray(img)
    x.append(data)
    x = np.array(x)
    ...
    with tf.Session() as sess:
        saver.restore(sess,'C:\\Users\\judy8\\Downloads\\model.ckpt')
    ...
    print("result")
    print("test accuracy :{}".format(p_val))
